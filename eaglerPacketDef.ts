import { PROTOCOL_EAGLER_VERSION, PROTOCOL_MINECRAFT_VERSION } from "./config.js"
...
export type IdentifyS = [EaglerPacketId.IDENTIFY_SERVER, 0x00, typeof PROTOCOL_EAGLER_VERSION, 0x00, typeof PROTOCOL_MINECRAFT_VERSION, number, string, number, string]
